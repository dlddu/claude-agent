...
| Spec ID | 명세 제목 | 구현 파일 | 테스트 파일 | 상태 | 비고 |
|---------|----------|----------|------------|------|------|
| [DATA-001](./data/DATA-001.md) | Database Schema & Data Models | packages/backend/prisma/schema.prisma, packages/shared/src/types/*.ts, packages/backend/src/dto/*.ts | - | 🚧 진행중 | Prisma Schema 및 타입 정의 구현 |
...
| 2025-12-27 | DATA-001 | Prisma Schema, TypeScript 타입, DTO 구현 시작 | Claude |
